...
import illuDependabot from "../../../assets/images/illu-dependabot-d98c73cc6724.png";
        ...
        <div className="feature-card-mktg flex mx:block rounded-lg color-bg-subtle borderNew relative justify-between z-1 h-full flex-col">
          <div className="flex mx:block pr-32 py-16 pl-16 mx:p-8 flex-1 flex-col justify-start">
            <p className="f2-mktg font-medium color-fg-muted mb-6">
              <em className="text-white">Dependabot </em> makes it easy to find
          ...
          <div className="overflow-hidden rounded-ee-lg rounded-bottom-3">
            <picture>
              <source
                srcSet={`${illuDependabot}?width=1209&amp;format=webpll 1209w,${illuDependabot}?width=967&amp;format=webpll 967w,${illuDependabot}?width=725&amp;format=webpll 725w,${illuDependabot}?width=604&amp;format=webpll 604w,${illuDependabot}?width=483&amp;format=webpll 483w,${illuDependabot}?width=241&amp;format=webpll 241w`}
                sizes="(max-width: 768px) 90vw, (max-width: 1280px) 50vw, 604px"
                type="image/webp"
              />
              <source
                srcSet={`${illuDependabot} 1209w,${illuDependabot}?width=604 604w,${illuDependabot}?width=483 483w,${illuDependabot}?width=302 302w`}
                sizes="(max-width: 768px) 90vw, (max-width: 1280px) 50vw, 604px"
                type="image/png"
              />
              <img
